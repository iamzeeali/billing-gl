      ...
      >
        <div className='p-4'>
          ...
          <div className='form-group row'>
            ...
            <label className='col-form-label col-sm-1'>Warehouse</label>
          ...
          <div className='form-group row'>
            <label className='col-form-label col-sm-1'>Country</label>
            <div className='col-sm-5'>
              <Input
                className='form-control '
                name='country'
            ...
            <label className='col-form-label col-sm-1'>State</label>
            <div className='col-sm-5'>
              <Input
                className='form-control '
                name='state'
          ...
          <div className='form-group row'>
            <label className='col-form-label col-sm-1'>City</label>
            <div className='col-sm-5'>
              <Input
                className='form-control '
                name='city'
            ...
            <label className='col-form-label col-sm-1'>Pin Code</label>
            <div className='col-sm-5'>
              <Input
                className='form-control '
                name='pincode'
          ...
          <div className='form-group row'>
            <label className='col-form-label col-sm-1'>Address</label>
            <div className='col-sm-5'>
              <textarea
                className='form-control '
                name='address'
